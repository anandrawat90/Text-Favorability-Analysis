...
csv_logger = CSVLogger('./logs/TL_cuDNNLSTM_GloVe.csv')
tb = TensorBoard(log_dir='./logs/TL_cuDNNLSTM_GloVe',histogram_freq=1, batch_size=batch_size,
                 write_graph=True, write_grads=False, write_images=False, embeddings_freq=0,
                 embeddings_layer_names=None, embeddings_metadata=None)
hist = model.fit(X_train, Y_train, epochs = 8, batch_size=batch_size,
                 verbose = 1, callbacks=[tb,csv_logger],validation_data=(X_validate,Y_validate))
model.save('./models/TL_cuDNNLSTM_GloVe.h5')
